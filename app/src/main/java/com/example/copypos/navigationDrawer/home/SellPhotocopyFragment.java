...
public class SellPhotocopyFragment extends Fragment implements ServiceListView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pDialog.setMessage("Mengambil daftar fotokopi");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        psc.getAllPhotocopy(spc.getSPBranchId(), "");
        swipeRefresh.setOnRefreshListener(() -> psc.getAllPhotocopy(spc.getSPBranchId(), ""));
    ...
    public static SellPhotocopyFragment newInstance() {
        SellPhotocopyFragment f = new SellPhotocopyFragment();
