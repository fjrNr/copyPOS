...
public class SellServiceFragment extends Fragment implements ServiceListView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pDialog.setMessage("Mengambil daftar jasa lain");
    ...
    public void onGetResultService(List<Service> services) {
        pDialog.hide();
        adapter = new ServiceListAdapter(getContext(), services, itemClickListener);
    ...
    public static Fragment newInstance() {
        SellServiceFragment f = new SellServiceFragment();
